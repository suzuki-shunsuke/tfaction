...
// Don't dismiss approvals if the plan result is the same as the previous plan.
// Enabled by default.
// The plan result is compared by a one-way hash stored in the plan metadata.
// With aws_kms_key_id, the hash is an HMAC generated by the AWS KMS key.
const SkipDismissIfUnchanged = z.object({
  enabled: z.boolean().optional(),
  aws_kms_key_id: z.string().optional(),
  aws_region: z.string().optional(),
});
export type SkipDismissIfUnchanged = z.infer<typeof SkipDismissIfUnchanged>;
...
export const RawConfig = z.object({
  ...
  dismiss_approval_before_plan: z
    .object({
      enabled: z.boolean().optional(),
      skip_if_unchanged: SkipDismissIfUnchanged.optional(),
    })
    .optional(),
