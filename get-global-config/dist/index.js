...
try {
    ...
    core.setOutput('aqua_update_checksum_skip_push', JSON.stringify(config.aqua && config.aqua.update_checksum && config.aqua.update_checksum.skip_push && !process.env.TFACTION_DRIFT_ISSUE_NUMBER));
    core.info(`aqua_update_checksum_skip_push ${JSON.stringify(config.aqua && config.aqua.update_checksum && config.aqua.update_checksum.skip_push && !process.env.TFACTION_DRIFT_ISSUE_NUMBER)}`);
    core.setOutput('aqua_update_checksum_prune', JSON.stringify(config.aqua && config.aqua.update_checksum && config.aqua.update_checksum.prune));
