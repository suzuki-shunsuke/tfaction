...
exports.createIssue = exports.listWorkingDirFiles = exports.getTargetGroup = exports.setEnvs = exports.setOutputs = exports.setValues = exports.getJobConfig = exports.readTargetConfig = exports.getTargetFromTargetGroupsByWorkingDir = exports.getIsApply = exports.getWorkingDir = exports.getTarget = exports.createWDTargetMap = exports.getConfig = exports.getJobType = void 0;
...
const TflintConfig = zod_1.z.object({
    enabled: zod_1.z.optional(zod_1.z.boolean()),
    fix: zod_1.z.optional(zod_1.z.boolean()),
});
...
const getTargetGroup = (config, target, workingDir) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const wds = [];
    const files = yield (0, exports.listWorkingDirFiles)((_c = config.working_directory_file) !== null && _c !== void 0 ? _c : "tfaction.yaml");
...
const listWorkingDirFiles = (file) => __awaiter(void 0, void 0, void 0, function* () {
    const out = yield exec.getExecOutput("git", ["ls-files"], {
        silent: true,
    });
    const files = [];
...
exports.listWorkingDirFiles = listWorkingDirFiles;
const createIssue = (target, ghToken, repoOwner, repoName) => __awaiter(void 0, void 0, void 0, function* () {
