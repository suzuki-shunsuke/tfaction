...
export declare const getTargetFromTargetGroups: (targetGroups: Array<TargetConfig>, target: string) => TargetConfig | null;
export declare const getTargetFromTargetGroupsByWorkingDir: (targetGroups: Array<TargetConfig>, wd: string) => TargetConfig | null;
