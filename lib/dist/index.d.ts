...
export declare const listWorkingDirFiles: (file: string) => Promise<string[]>;
type Issue = {
    url: string;
    number: number;
    state: string;
...
export declare const createIssue: (target: string, ghToken: string, repoOwner: string, repoName: string) => Promise<Issue>;
export {};
